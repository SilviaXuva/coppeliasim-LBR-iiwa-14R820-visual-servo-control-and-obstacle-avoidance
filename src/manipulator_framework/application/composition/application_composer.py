...
class ApplicationComposer:
    ...
    def _runtime_execution_service(self) -> RuntimeExecutionService:
        return RuntimeExecutionService(clock=self.clock)

    def _run_result_factory(self) -> RunResultFactory:
        return RunResultFactory()

    def build_run_joint_trajectory(self) -> RunJointTrajectory:
        return RunJointTrajectory(
            execution_engine=self.execution_engine,
            runtime_execution_service=self._runtime_execution_service(),
            run_result_factory=self._run_result_factory(),
